...
function Footer() {
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 pt-20 pb-10 px-20 font-["Founders_Gortesk_X-Condensed"]'>
      <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='heading'>
            <h1 className='text-[5vw] font-semibold uppercase leading-none '>Eye-</h1>
            <h1 className='text-[5vw] font-semibold uppercase leading-none '>Opening</h1>
        </div>
      ...
      <div className='w-1/2'>
        <div className='heading'>
            <h1 className='text-[4.7vw] font-semibold uppercase leading-none '>Presentations</h1>
        </div>
        <div className=''>
          <h1>202-1965 W 4th Ave
              Vancouver, Canada
        ...
        <div className='dets font-["Neue-Montreal"] mt-[100px] inline-block'>
